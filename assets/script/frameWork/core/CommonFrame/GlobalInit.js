...
tywx.isInCreator = !("wechatgame"===cc.sys.browserType);
...
tywx.SystemInfo = {
    ...
    //线上
    webSocketUrl: 'ws://open.andla.cn/', 
    loginUrl : 'http://182.254.154.91:10200/yang/',

    // loginUrl : "https://自己的url/",      //仿真
    // loginUrl : "http://l自己的url/"          //线上
    shareManagerUrl : 'https://market.touch4.me/',
    deviceId: 'wechatGame',
    wxAppId: 'wxbfa701d7eb3aead5',
    areaUrl : "",
    appId: "20006",
    gameId: "20006",
    cdnPath:"https://xiaoyouxi.qiniu.andla.cn/pkgame/animalChess",
    remotePackPath:"",
    biLogServer : "",
    errorLogServer : "",
...
(function() {
    ...
    {
        return tywx.hex_md5("abc") == "900150983cd24fb0d6963f7d28e17f72";
    }
